...
public class TestSDK
{
	...
	public void init()
	{
		...
		parser = new AfHtmlImageParser(tmpDir);
	...
	public void process(String html) throws Exception
	{
		String str = parser.process(html, this);
